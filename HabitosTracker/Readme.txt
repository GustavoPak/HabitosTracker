...
Tratamento de erros como parte do dominio - Na camada de dominio agora existe uma classe especifica de exceção,que 
apenas será usada na camada de dominio,para ser facilmente identificavel qual o tipo da exceção (nada generico,é literalmente o DOMAINexception.

Invariantes de dominio: validação diretamente no construtor do dominio,que não deixa ser criado variáveis de classes
inválidas.
